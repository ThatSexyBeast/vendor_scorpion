...
PRODUCT_COPY_FILES += \
    ...
    vendor/scorpion/prebuilt/common/bin/50-base.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-base.sh
...
PRODUCT_COPY_FILES += \
    vendor/scorpion/config/backup.xml:system/etc/sysconfig/backup.xml
...
# Configs
PRODUCT_COPY_FILES += \
    vendor/scorpion/prebuilt/common/etc/sysconfig/dialer_experience.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/dialer_experience.xml \
    vendor/scorpion/prebuilt/common/etc/sysconfig/turbo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/turbo.xml

# Copy all Scorpion-specific init rc files
$(foreach f,$(wildcard vendor/scorpion/prebuilt/common/etc/init/*.rc),\
...
# Versioning
include vendor/scorpion/config/version.mk
